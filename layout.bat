...
:menu
    ...
    powershell -command "Write-Host ' MOVER O COMMON PARA A PASTA DO SAP LOGON'`n -BackgroundColor Magenta"
    powershell -command "Write-Host '      [3]' -ForegroundColor White -NoNewLine"
    powershell -command "Write-Host ' OPCOES DE DOMINIO (REMOVER OU COLOCAR MAQUINA NO DOMINIO)'`n -BackgroundColor Magenta"
    powershell -command "Write-Host '      [4]' -ForegroundColor White -NoNewLine"
    powershell -command "Write-Host ' FAZER BACKUP DA MAQUINA'`n`n`n -BackgroundColor Magenta"

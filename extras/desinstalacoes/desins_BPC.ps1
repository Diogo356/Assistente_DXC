function desins_BPC {
    ...
    if(($verify_bpc) -and ($verify_epm)) {
        ...
        Write-Host "Estas ferramentas ja foram desinstaladas" -ForegroundColor Cyan
        Write-Host "Caso elas ainda permanecam nesse computador, Entrem em contato com o desenvolvedor responsavel e apresente o caso" -ForegroundColor Cyan
    }
    Start-Sleep(2)
}